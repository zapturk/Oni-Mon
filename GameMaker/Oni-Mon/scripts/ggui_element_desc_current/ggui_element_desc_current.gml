///ggui_element_desc_current(dl,dt)
function ggui_element_desc_current(argument0, argument1) {
	var gf = ggui_frames - 1;
	ggui_frame_element_type[    gf,ggui_frame_elements[gf]] = gguielt_CURRDESC;
