///ggui_element_arbtext_scrollable(dl,dt,arraydeltax,ady,arbindex)
function ggui_element_arbtext_scrollable(argument0, argument1, argument2, argument3, argument4) {
	//Must have properly set up the menu size
	var gf = ggui_frames - 1;
	ggui_frame_element_type[    gf,ggui_frame_elements[gf]] = gguielt_SCARBTEXT;
