///ggui_element_desc_scrollable(dl,dt,arraydeltax,ady)
function ggui_element_desc_scrollable(argument0, argument1, argument2, argument3) {
	var gf = ggui_frames - 1;
	ggui_frame_element_type[    gf,ggui_frame_elements[gf]] = gguielt_SCDESC;
